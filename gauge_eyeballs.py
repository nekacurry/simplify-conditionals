...
queen_eye_size = eye_size > 0.45
queen_iris_area = (math.pi*iris_width/2*iris_height/2) / eye_size >= 0.69
queen_eye_ratio = eye_height/eye_width >= 0.59

if queen_eye_ratio and queen_eye_size and queen_iris_area:
